---
title: "Chapitre 5 — Score et changement de côté"
description: "Comment les points sont attribués, quand une partie se termine, comment fonctionne le décideur du troisième match et quand les joueurs changent de camp."
weight: 5
date: 2026-01-01
author: "International Carrom Federation"
translatedBy: "Traduit de l'anglais (brouillon IA)."
---
*Carrom se joue en matchs de trois matchs. Chaque jeu est une séquence de plateaux. Chaque tableau vaut des points, et le premier à 25 points (ou celui qui mène après huit tableaux) remporte la partie. Ce chapitre est la référence en matière de notation.*
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;c) Le joueur qui perd le plateau n'est pas crédité de la valeur du Queen, même s'il a empoché et recouvert le Queen.
...
**56.** &nbsp;&nbsp;a) Un jeu doit comporter **25 points ou huit plateaux**. Le joueur qui atteint 25 points en premier, ou qui mène à la fin du huitième plateau, remporte la partie.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;b) Jusqu'aux pré-quarts de finale inclus, chaque match est décidé sur la base de **huit échiquiers**. Si le score est égal à la fin du huitième plateau, un **tableau supplémentaire** est joué. Avant le tableau supplémentaire, il y aura un tirage au sort pour choisir uniquement la pause.

**57.** Tous les matchs seront décidés par le **meilleur des trois matchs**.

## Changement de côté

| Formater | Quand les côtés changent |
|---|---|
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;c) Si le changement de côté reste inaperçu par l'arbitre ou par tout joueur, il a lieu au fur et à mesure qu'il est remarqué - mais après la fin de ce tableau particulier.

**61.** Les joueurs ne doivent pas mettre plus de **deux minutes** pour changer de côté.
