...
[![Languages: 12](https://img.shields.io/badge/Languages-12-7dd3fc?style=flat-square)](#languages)
...
Three decades of carrom coaching from **Shri Arun Deshpande** — 7× Maharashtra State Champion and former coach of the India National Carrom Team — gathered in one place, free to read and free to download, in 12 languages.
...
- 🌐 **12 languages** — English, Dansk, Deutsch, मराठी, Italiano, Français, සිංහල, हिन्दी, ગુજરાતી, Polski, ꯃꯩꯇꯩꯂꯣꯟ, தமிழ் — auto-detected from your browser at the root URL
...
Every page of the site translates to **English, Dansk, Deutsch, मराठी, Italiano, Français, සිංහල, हिन्दी, ગુજરાતી, Polski, ꯃꯩꯇꯩꯂꯣꯟ, தமிழ்**. So do both PDF downloads. The language switcher in the top-right groups them by region (International / European / South Asian) so you can find yours fast — and the site auto-detects your browser's preferred language at the root URL so most visitors never have to switch manually.
...
|---|---|---|---|
| `en` | English | English | World |
| `da` | Danish | Dansk | World |
| `de` | German | Deutsch | World |
| `it` | Italian | Italiano | World |
| `fr` | French | Français | World |
| `mr` | Marathi | मराठी | Asia |
| `hi` | Hindi | हिन्दी | Asia |
| `gu` | Gujarati | ગુજરાતી | Asia |
| `pl` | Polish | Polski | World |
| `si` | Sinhala | සිංහල | Asia |
| `mni` | Manipuri (Meitei) | ꯃꯩꯇꯩꯂꯣꯟ | Asia |
| `ta` | Tamil | தமிழ் | Asia |
